        ...
        <nav class="navbar navbar-expand-md navbar-dark bg-dark">
            <div class="container">
                ...
                <div class="collapse navbar-collapse justify-content-end" id="navbarsExampleDefault">
                    ...
                    <form class="form-inline my-2 my-lg-0" action="SearchProductController">
                        <div class="input-group input-group-sm">
                            <input type="text" class="form-control" aria-label="Small" aria-describedby="inputGroup-sizing-sm" placeholder="Search..." name = "txtSearch">
            ...
            <div class="row">
                <div class="col-12 col-sm-3">
                    ...
                    <div class="card bg-light mb-3">
                        ...
                        <div class="card-body">
                            <img class="img-fluid" src="https://anphat.com.vn/media/product/31629_5328_asus_a412fa_ek155t_anh4_2.jpg" />
